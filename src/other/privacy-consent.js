...
if (!navigator.userAgent.includes("Gecko/")) {
    ...
    if ($link) {
        if (process.env.PRODUCT === "Dictionariez") {
            $link.href = "https://addons.mozilla.org/en-US/firefox/addon/dictionaries/privacy/";
        } else if (process.env.PRODUCT === "Ordböcker") {
            $link.href = "https://addons.mozilla.org/en-US/firefox/addon/ordb%C3%B6cker/privacy/";
        }
    }
}
