...
@media (max-width: 1280px) {
  ...
  #PNLTranslatorContainer .errorMessages-module__pnl-reader-error-banner___Qrqdy.errorMessages-module__for-audio___ez0R_ {
    ...
    padding: 0.5em 1.2em;
    border-radius: 6px;
    bottom: calc(48px + 1em + 1.4em + 0.5em);
  }
}
@media (max-width: 576px) {
  ...
  #PNLTranslatorContainer .errorMessages-module__pnl-reader-error-banner___Qrqdy.errorMessages-module__for-audio___ez0R_ {
    ...
    max-width: 98vw;
    padding: 0.5em 0.5em;
    bottom: calc(48px + 1.4em + 0.5em);
  }
}`, "",{"version":3,"sources":["webpack://./src/content/errorMessages.module.scss"],"names":[],"mappings":"AAUE;;;EACE,4BAAA;EACA,8BAAA;AAPJ;AASI;;;EACE,0BAAA;EACA,qBAAA;EACA,cAAA;AALN;AAQI;;;EACE,6BAAA;AAJN;AAOI;;;EACE,eAAA;EACA,SAAA;EACA,wCAAA;EAGA,2BAAA;EACA,6CAAA;EACA,gDAAA;EACA,kBAAA;EACA,kBAAA;EACA,gBAAA;EACA,eAAA;EACA,UAAA;AALN;AAOM;EAfF;;;IAgBI,kBAAA;IACA,eAAA;IACA,iBAAA;IACA,oBAAA;IACA,kBAAA;IACA,wCAAA;EAFN;AACF;AAMM;EA1BF;;;IA2BI,kBAAA;IACA,eAAA;IACA,oBAAA;IACA,kCAAA;EADN;AACF","sourcesContent":[":global(#PNLReader),\n:global(#PNLTTSPlayerContainer),\n:global(#PNLTranslatorContainer) {\n  $playBarBottomSpacing: 2em;\n  $playBarPaddingVertical: 1.2em;\n\n  $playBarBottomSpacingOnMacbookAir: 1em;\n  $playBarBottomSpacingOnMobile: 0px;\n  $playBarPaddingVerticalOnMobile: 0.7em;\n\n  .pnl-reader-error-banner {\n    color: var(--pico-del-color);\n    visibility: visible !important; // override some website(reddit) styles that hide it\n\n    a {\n      color: var(--pico-primary);\n      text-decoration: none;\n      padding: 0 5px;\n    }\n\n    &.in-trial {\n      color: var(--pico-code-color);\n    }\n\n    &.for-audio {\n      position: fixed;\n      left: 50%;\n      bottom: calc(\n        80px + $playBarBottomSpacing + $playBarPaddingVertical * 2 + 0.5em\n      );\n      transform: translateX(-50%);\n      background: var(--pico-code-background-color);\n      border: 1px solid var(--pico-table-border-color);\n      border-radius: 8px;\n      padding: 10px 20px;\n      margin-bottom: 0;\n      max-width: 80vw;\n      z-index: 2;\n\n      @media (max-width: 1280px) {\n        width: max-content;\n        max-width: 98vw;\n        font-size: 0.97em;\n        padding: 0.5em 1.2em;\n        border-radius: 6px;\n        bottom: calc(\n          48px + $playBarBottomSpacingOnMacbookAir +\n            $playBarPaddingVerticalOnMobile * 2 + 0.5em\n        );\n      }\n      @media (max-width: 576px) {\n        width: max-content;\n        max-width: 98vw;\n        padding: 0.5em 0.5em;\n        bottom: calc(\n          48px + $playBarBottomSpacingOnMobile + $playBarPaddingVerticalOnMobile *\n            2 + 0.5em\n        );\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
#PNLReader #PNLReaderArticle #PNLReaderArticleContent [data-tooltip]:focus:not(:hover)::before, #PNLReader #PNLReaderArticle #PNLReaderArticleContent [data-tooltip]:focus:not(:hover)::after,
#PNLTranslatorContainer [data-tooltip]:focus:not(:hover)::before,
#PNLTranslatorContainer [data-tooltip]:focus:not(:hover)::after {
  opacity: 0 !important;
}
...
#PNLTranslatorContainer article.translator-module__translator-panel___N_B9c .translator-module__translator-header___o6u_7 .translator-module__translator-lang-selector___GFfSB .translator-module__translator-target-select___K8ne0 {
  ...
  border-radius: 0;
  padding: 0.25em 1.2em 0.25em 0.45em;
  margin-bottom: 0;
  font-size: 0.9em;
  height: auto;
  min-height: unset;
...
}`, "",{"version":3,"sources":["webpack://./src/content/translation/translator.module.scss"],"names":[],"mappings":"AAII;EAFF;;IAGI,wBAAA;EADJ;AACF;AAQM;;;EAEE,qBAAA;AALR;AAUE;;EACE,eAAA;EACA,gBAAA;EACA,wCAAA;EACA,6CAAA;EACA,iBAAA;EACA,kBAAA;EACA,iDAAA;EAEA,8BAAA;AARJ;AAUI;EAXF;;IAYI,kBAAA;EANJ;AACF;AAQI;;EACE,kBAAA;EAKA,kBAAA;EACA,UAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,UAAA;EACA,iBAAA;EACA,gBAAA;AATN;AAFM;EAFF;;IAGI,mBAAA;IACA,oBAAA;EAMN;AACF;AAIM;;EACE,aAAA;EACA,mBAAA;EACA,OAAA;EACA,YAAA;AADR;AAEQ;EALF;;IAMI,UAAA;EAER;AACF;AAAQ;;EACE,aAAA;EACA,mBAAA;EACA,WAAA;EACA,mBAAA;EACA,cAAA;EACA,kBAAA;EACA,gBAAA;AAGV;AADU;EATF;;IAUI,YAAA;EAKV;AACF;AAHU;;;;;;EAGE,8BAAA;AAQZ;AALU;;EACE,cAAA;AAQZ;AAJQ;;EACE,sBAAA;EACA,cAAA;EACA,mBAAA;EAGA,YAAA;EACA,uDAAA;EACA,gBAAA;EACA,mCAAA;EACA,gBAAA;EACA,gBAAA;EACA,YAAA;EACA,iBAAA;EAGA,+PAAA;EACA,mCAAA;EACA,0BAAA;EACA,4BAAA;AAGV;AADU;;EACE,aAAA;EACA,gBAAA;EACA,wCAAA;AAIZ;AADU;;EACE,wCAAA;AAIZ;AACM;;EACE,gBAAA;EACA,YAAA;EACA,eAAA;EACA,8BAAA;EACA,qBAAA;EACA,yBAAA;EACA,cAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,SAAA;EACA,kBAAA;AAER;AAAQ;EAjBF;;IAkBI,eAAA;EAIR;AACF;AAFQ;;EACE,uBAAA;AAKV;AAAI;;;;EAEE,kBAAA;EACA,cAAA;AAIN;AAFM;;;;;;;;EAEE,SAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,UAAA;EACA,gBAAA;AAUR;AALM;;EACE,8BAAA;EACA,kBAAA;AAQR;AALM;;EACE,gBAAA;AAQR;AAJI;;EACE,kCAAA;EACA,wCAAA;EACA,qBAAA;EACA,WAAA;AAON;AALM;;EACE,mCAAA;AAQR;AALM;;EACE,mCAAA;AAQR;AAHM;;EACE,cAAA;EACA,eAAA;EACA,cAAA;AAMR;AALQ;;EACE,gCAAA;EACA,wBAAA;AAQV;AALU;;EACE,mCAAA;AAQZ;AADM;;EACE,WAAA;EACA,iBAAA;EACA,eAAA;EACA,kBAAA;AAIR;AADI;;EACE,gBAAA;EACA,YAAA;EACA,8BAAA;EACA,cAAA;EACA,eAAA;EACA,qBAAA;EACA,eAAA;EACA,YAAA;EACA,yBAAA;EACA,gBAAA;AAIN;AAHM;;EACE,aAAA;AAMR;AAHM;;EACE,UAAA;EACA,qCAAA;AAMR;AAHM;;EACE,aAAA;EACA,UAAA;AAMR;AAFI;;EACE,0FAAA;AAKN;AAFI;;EACE,sBAAA;EACA,UAAA;EACA,oBAAA;AAKN;AAFI;EACE;IACE,sBAAA;IACA,UAAA;EAIN;EAFI;IACE,mBAAA;IACA,UAAA;EAIN;AACF","sourcesContent":[":global(#PNLReader #PNLReaderArticle #PNLReaderArticleContent),\n:global(#PNLTranslatorContainer) {\n  .hide-sm {\n    // copied from inject.scss\n    @media (max-width: 960px) {\n      display: none !important;\n    }\n  }\n\n  [data-tooltip] {\n    // copied from inject.scss\n    // fix tooltip visibility issue when cursor has left the element\n    &:focus:not(:hover) {\n      &::before,\n      &::after {\n        opacity: 0 !important;\n      }\n    }\n  }\n\n  article.translator-panel {\n    max-width: none; // Allow full width within paragraph\n    margin-bottom: 0;\n    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n    background: var(--pico-code-background-color);\n    padding: 1em 18px;\n    position: relative;\n    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n\n    visibility: visible !important; // override some website(reddit) styles that hide it such as reddit\n\n    @media (max-width: 768px) {\n      padding: 0.2em 6px;\n    }\n\n    .translator-header {\n      margin: -1em -18px;\n      @media (max-width: 768px) {\n        margin: -0.2em -6px;\n        margin-bottom: 0.5em;\n      }\n      margin-bottom: 1em;\n      padding: 0;\n      display: flex;\n      justify-content: space-between;\n      align-items: center;\n      gap: 0.5em; // Reduce gap\n      flex-wrap: nowrap; // Prevent wrapping\n      overflow: hidden; // Prevent overflow\n\n      .translator-lang-selector {\n        display: flex;\n        align-items: center;\n        flex: 1;\n        min-width: 0; // Allow shrinking\n        @media (max-width: 768px) {\n          flex: none;\n        }\n\n        .translator-lang-info {\n          display: flex;\n          align-items: center;\n          gap: 0.25em; // Reduce gap\n          white-space: nowrap;\n          flex-shrink: 1; // Allow this to shrink first\n          padding: 18px 24px;\n          font-size: 0.9em;\n\n          @media (max-width: 768px) {\n            padding: 5px; // Remove padding on small screens\n          }\n\n          .translator-from-label,\n          .translator-from-lang,\n          .translator-to-label {\n            color: var(--pico-muted-color);\n          }\n\n          .translator-arrow {\n            font-size: 1em; // Smaller arrow\n          }\n        }\n\n        .translator-target-select {\n          max-width: max-content;\n          flex-shrink: 0;\n          font-weight: bolder;\n\n          // Minimal bottom-border style\n          border: none;\n          border-bottom: 1px solid var(--pico-muted-border-color);\n          border-radius: 0;\n          padding: 0.25em 1.2em 0.25em 0.45em;\n          margin-bottom: 0;\n          font-size: 0.9em;\n          height: auto;\n          min-height: unset;\n\n          // Style the dropdown arrow\n          background-image: url(\"data:image/svg+xml;charset=utf-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23495057' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\");\n          background-position: right 0 center;\n          background-size: 16px 12px;\n          background-repeat: no-repeat;\n\n          &:focus {\n            outline: none;\n            box-shadow: none;\n            border-bottom-color: var(--pico-primary);\n          }\n\n          &:hover {\n            border-bottom-color: var(--pico-primary);\n          }\n        }\n      }\n\n      .translator-close-btn {\n        background: none;\n        border: none;\n        cursor: pointer;\n        color: var(--pico-muted-color);\n        border-radius: 0.25em;\n        transition: all 0.2s ease;\n        flex-shrink: 0;\n        width: 32px;\n        height: 32px;\n        font-size: 16px;\n        line-height: 32px;\n        text-align: center;\n        padding: 0;\n        margin: 0;\n        margin-right: 18px;\n\n        @media (max-width: 768px) {\n          margin-right: 0;\n        }\n\n        &:hover {\n          filter: brightness(1.5);\n        }\n      }\n    }\n\n    .translator-prompt,\n    .translator-warning {\n      text-align: center;\n      padding: 1.5em;\n\n      .translator-prompt-text,\n      .translator-warning-text {\n        margin: 0;\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        gap: 0.5em;\n        font-size: 0.9em;\n      }\n    }\n\n    .translator-prompt {\n      .translator-prompt-text {\n        color: var(--pico-muted-color);\n        font-style: italic;\n      }\n\n      .translator-prompt-icon {\n        font-size: 1.1em;\n      }\n    }\n\n    .translator-warning {\n      background: rgba(255, 193, 7, 0.1);\n      border: 1px solid rgba(255, 193, 7, 0.3);\n      border-radius: 0.25em;\n      margin: 1em;\n\n      .translator-warning-text {\n        color: var(--pico-warning, #856404);\n      }\n\n      .translator-warning-icon {\n        color: var(--pico-warning, #ffc107);\n      }\n    }\n\n    .translator-content {\n      &.tts-paragraph-wrap {\n        display: block;\n        padding-left: 0;\n        margin-left: 0;\n        .tts-paragraph {\n          text-decoration: none !important;\n          color: var(--pico-color);\n        }\n        &--active {\n          .tts-paragraph {\n            color: var(\n              --pico-primary,\n              #ffd700\n            ); // subtle text highlight using theme color\n          }\n        }\n      }\n      .translator-footer {\n        width: 100%;\n        text-align: right;\n        margin-top: 1em;\n        position: relative;\n      }\n    }\n    button {\n      background: none;\n      border: none;\n      color: var(--pico-muted-color);\n      font-size: 1em;\n      padding: 0.25em;\n      border-radius: 0.25em;\n      cursor: pointer;\n      opacity: 0.7;\n      transition: all 0.2s ease;\n      margin-bottom: 0;\n      &[hidden=\"true\"] {\n        display: none;\n      }\n\n      &:hover {\n        opacity: 1;\n        background: var(--pico-primary-focus);\n      }\n\n      &:focus {\n        outline: none;\n        opacity: 1;\n      }\n    }\n\n    &.translator-entering {\n      animation: translatorScaleIn 0.25s cubic-bezier(0.4, 0, 0.2, 1);\n    }\n\n    &.translator-closing {\n      transform: scale(0.96);\n      opacity: 0;\n      pointer-events: none;\n    }\n\n    @keyframes translatorScaleIn {\n      from {\n        transform: scale(0.96);\n        opacity: 0;\n      }\n      to {\n        transform: scale(1);\n        opacity: 1;\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
