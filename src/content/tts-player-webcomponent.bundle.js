...
#PNLTTSPlayerContainer .ttsPlayer-module__tts-player-bar____2rF8 .ttsPlayer-module__tts-voice-dropdown-item___bv_1v:focus {
  background: var(--pico-primary-focus, #353a45);
}
