...
var options = {
    ...
    entry: {
        ...
        dictheader: path.join(__dirname, "src", "content", "dictheader.js"),
        card: path.join(__dirname, "src", "content", "card.js"),
        options: path.join(__dirname, "src", "option", "option.js"),
            ...
            patterns: [
                {
                    ...
                    transform: function (content) {
                        ...
                        if (env.BROWSER === "Firefox") {
                            ...
                            json.permissions = json.permissions.filter((x) => x !== "offscreen" && x !== "sidePanel");
                            json.permissions.push("<all_urls>");
                            json["web_accessible_resources"] = ["*.js", "*.json", "*.html", "fonts/*"];
